      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data Barang</a>
          </div>
              ...
              <form class="form-horizontal" action="add_barang.php" method="post">
               <div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="kd_barang" placeholder="Masukan Kode Barang">
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="jumlah" placeholder="Masukan Jumlah Barang">
                </div>      
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
    include 'koneksi.php';
    $stid = oci_parse($con, 'SELECT * from barang_1001');
    ...
    while (($d = oci_fetch_array ($stid, OCI_BOTH)) != false) {
      ?>
                        <tr>                          
                          ...
                          <td class="td-actions">
              <a href="up_barang.php?id=<?= $d['KD_BARANG'] ?>">
                            <button type="button" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">edit</i>
                            </button></a>
              <a href="del_barang.php?id=<?= $d['KD_BARANG'] ?>" 
